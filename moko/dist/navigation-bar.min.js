var navTemplateString =
  '<style>.back-zone {\n        flex-grow: 1;\n        width: 20%;\n        display: flex;\n        align-items: center;\n        padding-left: 10px;\n    }\n\n    .back-zone img {\n        width: 15px;\n    }\n\n    .back-zone span {\n        flex-grow: 1;\n    }\n\n    .center-zone {\n        flex-grow: 2;\n        display: flex;\n        align-items: center;\n        justify-content: center;\n    }\n\n    .right-zone {\n        flex-grow: 1;\n        width: 20%;\n        display: flex;\n        align-items: center;\n        padding-left: 10px;\n    }\n\n    :host {\n        display: flex;\n        position: fixed;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 40px;\n        background: #fff;\n        color: #555;\n        box-sizing: border-box;\n    }</style><div class="back-zone"><slot></slot><span></span></div><div class="center-zone"><span></span></div><div class="right-zone"><slot name="right"></slot></div>'
  ...
  constructor() {
    super(),
      this.attachShadow({ mode: 'open' }).appendChild(
        navTemplate.content.cloneNode(!0)
      )
  }
