!(function(e) {
  ...
  ;(i.m = e),
    (i.c = n),
    (i.d = function(e, n, l) {
      i.o(e, n) || Object.defineProperty(e, n, { enumerable: !0, get: l })
    }),
    (i.r = function(e) {
  ...
  function(e, n, i) {
    ...
    function l(e, n) {
      const i = /(:\w+)/g,
        l = n.match(i) || []
      let t = []
      l.length > 0 && (t = l.map(e => e.slice(1)))
      const o = new RegExp(n.replace(i, '(\\w+)')),
        y = e.match(o)
      let s = {}
      if (y) {
        const [e, ...n] = y
        for (var a = 0; a < l.length; a++) s[t[a]] = n[a]
      }
      return { match: y, urlData: s }
    }
    i.r(n),
      i.d(n, 'NavigatorElement', function() {
        return t
      })
    class t extends HTMLElement {
      ...
      extractChildRoutes() {
        this.routes = Array.from(this.children).filter(
          e => 'MOKO-ROUTE' === e.tagName
        )
      }
      searchAncestor(e) {
        const n = e[0].parentElement.closest(
          'moko-switch-navigator, moko-stack-navigator, moko-tab-navigator'
        )
        return n ? this.searchAncestor([n, ...e]) : e
      }
      getContentElement() {
      ...
      connectedCallback() {
        this.extractChildRoutes(),
          this.navigators || (this.navigators = this.searchAncestor([this])),
          (this.urlData = {
            ...this.navigators.reduce((e, n) => ({ ...e, ...n.urlData }), {})
          }),
      ...
      navigate(e) {
        location.hash = `${this.getAncestorMatchedRoute()}/${e}`
      }
      getAncestorMatchedRoute() {
        return this.navigators
          .slice(0, this.navigators.length - 1)
          .reduce((e, n) => e + '/' + n.matchedRouteLocation, '')
      }
      getCurrentRelativeLocation(e = this.getAncestorMatchedRoute()) {
        let n = location.hash.substring(1).replace(e, '')
        return (n = '/' === n[0] ? n.replace('/', '') : n)
      }
      searchMatchingRoute() {
        let e,
          n,
          i,
          t,
          o = this.getAncestorMatchedRoute(),
          y = this.getCurrentRelativeLocation(o)
        if ('' === y) this.matchedRouteLocation = ''
        else {
          for (const o of this.routes) {
            ...
            if (s.match) {
              ;(n = s),
                ((e = o).selected = !0),
                (i = (t = n.match[0]) !== this.matchedRouteLocation)
              break
            }
          }
          i &&
            ((this.matchedRouteLocation = t),
            (this.urlData = { ...this.urlData, ...n.urlData }))
        }
        return {
          matchedRoute: e,
          matchedResult: n,
          ancestorMatchedRoute: o,
          routeChanged: i
        }
      }
    }
  ...
  function(e, n, i) {
    ...
    class l extends HTMLElement {
      ...
      removeFirstSlash(e) {
        return 0 === e.indexOf('/') ? e.substring(1) : e
      }
      attributeChangedCallback(e, n, i) {
        'path' === e
          ? (this._path = this.removeFirstSlash(i))
          : 'component' === e
          ? this._element || (this._element = i)
          : 'selected' === e && (this._selected = i)
      }
      get path() {
        return this._path
      }
    ...
    customElements.define('moko-route', l)
  },
  function(e, n, i) {
    'use strict'
    i.r(n),
    ...
    var l = i(3)
    const t = Object(l.customElement)(
      function() {
    ...
    customElements.define('moko-link', t)
  },
  function(e, n, i) {
    'use strict'
    i.r(n),
      i.d(n, 'customElement', function() {
        return l
      })
    const l = (e, n = []) => {
      const i = class extends HTMLElement {
        ...
        constructor() {
          super(), (this.connectedCallbackNumCalls = 0)
        }
        async connectedCallback() {
          if (this.connectedCallbackNumCalls > 0) return
          const n = e.bind(this)
          ;(this.toRender = await n(this)),
            'string' == typeof this.toRender
  ...
  function(e, n, i) {
    ...
    ;(t.innerHTML =
      '<slot>\x3c!-- ICON SLOT --\x3e</slot>\n<span>\x3c!-- title --\x3e</span>\n\n<style>\n    ::slotted(moko-icon) {\n        flex-grow: 1;\n        height: 18px;\n        padding-bottom: 5px;\n    }\n    span {\n        flex-grow: 1;\n    }\n</style>'),
      window.ShadyCSS &&
        (ShadyCSS.prepareTemplate(l, 'moko-tab-bar'),
        ShadyCSS.prepareTemplate(t, 'moko-tab'))
    class o extends HTMLElement {
      ...
      connectedCallback() {
        ...
        const e = this.shadowRoot.querySelector('span')
        this.getAttribute('title') &&
          (e.innerHTML = this.getAttribute('title')),
          this.querySelector('moko-icon') && (e.style.fontSize = '0.7em')
      }
      get name() {
        return this._name
      }
    ...
    customElements.define('moko-tab', o)
    class y extends HTMLElement {
      ...
      resetActiveColorForTabs() {
        Array.prototype.forEach.call(this.querySelectorAll('moko-tab'), e => {
          e.style.color = null
        })
      }
      connectedCallback() {
        window.ShadyCSS && ShadyCSS.styleElement(this),
          (this.onclick = e => {
            const n = e.target.closest('moko-tab')
            if (n) {
              const e = n.getAttribute('name')
              this.resetActiveColorForTabs(),
                (n.style.color = this.getAttribute('active-color')),
                this.dispatchEvent(
                  new CustomEvent('moko-tab-selected', { detail: { name: e } })
                )
            }
          })
      }
      ...
      set activeColor(e) {
        this.setAttribute('active-color', e)
      }
      set selected(e) {
        ;(this._currentTabSelected = this.querySelector(
          `moko-tab[name="${e}"]`
        )),
    ...
    customElements.define('moko-tab-bar', y)
  },
  function(e, n, i) {
    i(3),
      i(2),
  ...
  function(e, n, i) {
    ...
    class o extends l.NavigatorElement {
      static get observedAttributes() {
        return ['modal']
      }
      attributeChangedCallback(e, n, i) {
        'modal' === e && (this.modal || (this._modal = !('' !== i && !i)))
      }
      get modal() {
        return this._modal
      }
      setUrlData(e) {
        this.urlData &&
          Object.keys(this.urlData).forEach(n => {
            e.setAttribute(n, this.urlData[n])
          })
      }
      handleEvent(e) {
        const {
        ...
        if ((!n && this.nextRoute && this.onscreenFirstRoute(), n && i)) {
          const e = document.createElement(l.customElement)
          ;(e.style.display = 'block'),
            this.setUrlData(e),
            (this.nextRoute = t()),
            (this.nextRoute.innerHTML = ''),
            this.nextRoute.appendChild(e),
            this.offscreenNextRoute(),
            setTimeout(() => {
              this.appendChild(this.nextRoute),
                setTimeout(() => {
                  this.modal ||
                    (this.initialContentElement.style.transform =
                      'translateX(-30%)'),
                    this.showNextRouteElement(e)
                }, 16)
            })
        }
      }
      ...
      renderFirstRoute() {
        const e = document.createElement(this.routes[0].customElement)
        this.setUrlData(e), (e.style.display = 'block')
        const n = t()
        n.appendChild(e),
          this.initialContentElement
            ? this.initialContentElement.replaceWith(n)
            : this.appendChild(n),
          (this.initialContentElement = n)
      }
      constructor() {
        super(),
      ...
      connectedCallback() {
        super.connectedCallback(),
          ...
          0 == this.connectedCallbackNumCalls++ &&
            setTimeout(() => {
    ...
    customElements.define('moko-stack-navigator', o)
  },
  function(e, n, i) {
    'use strict'
    i.r(n),
      i.d(n, 'MokoSwitchNavigator', function() {
        return t
      })
    i(1), i(2)
    var l = i(0)
    class t extends l.NavigatorElement {
      connectedCallback() {
        super.connectedCallback(),
          (this.style.display = 'block'),
          (this.style.height = 'inherit'),
          (this.style.width = 'inherit'),
          (this.style.position = 'relative')
        const e = this.getAttribute('default-path')
        this.getContentElement()
          ? (this.matchedRouteLocation = e || this.routes[0].path)
          : this.getCurrentRelativeLocation()
          ? setTimeout(() => this.handleEvent())
          : this.navigate(e || this.routes[0].path)
      }
      handleEvent() {
        const {
          matchedResult: e,
        ...
        if (e && i) {
          Array.from(this.routes).forEach(e => (e.innerHTML = ''))
          const i = this.getContentElement()
          i && i.remove()
          const l = document.createElement(n.customElement)
          Object.keys(this.urlData).forEach(n => {
            l.setAttribute(n, e.urlData[n])
          }),
            this.appendChild(l),
            this.dispatchEvent(
              new CustomEvent('moko-switch-view', {
                detail: { matchedRoute: n },
                bubbles: !0
              })
            )
        }
    ...
    customElements.define('moko-switch-navigator', t)
  },
  function(e, n, i) {
    'use strict'
    i.r(n),
      i.d(n, 'TabRoute', function() {
        return o
      }),
      i.d(n, 'TabNavigator', function() {
        return s
      })
    var l = i(0),
      t = (i(4), i(1))
    class o extends t.MokoRoute {
      static get observedAttributes() {
        return [...t.MokoRoute.observedAttributes, 'title', 'icon']
      }
      attributeChangedCallback(e, n, i) {
        super.attributeChangedCallback(e, n, i),
          'icon' === e ? (this._icon = i) : 'title' === e && (this._title = i)
      }
      set title(e) {
        this.setAttribute('title', e)
      }
    ...
    customElements.define('moko-tab-route', o)
    ...
    class s extends l.NavigatorElement {
      static get observedAttributes() {
        return ['active-color']
      }
      attributeChangedCallback(e, n, i) {
      ...
      connectedCallback() {
        ...
        n && n.remove(), (this.containers = {}), (this.scrollsTop = {})
        const i = y.content.cloneNode(!0)
        this.appendChild(i),
          (this.$tabbar = this.querySelector('moko-tab-bar')),
          (this.$tabbar.activeColor = this._activeColor || '#A06CD5'),
          this.routes.forEach(e => {
            const n = document.createElement('moko-tab')
            ;(n.title = e.title),
              (n.name = e.path),
              e.icon &&
                (n.innerHTML = `<moko-icon name="${e.icon}"></moko-icon>`),
              this.$tabbar.appendChild(n)
          }),
          location.hash
            ? this.handleEvent()
            : this.navigate(e || this.routes[0].path),
          this.$tabbar.addEventListener('moko-tab-selected', e => {
            ;(this.currentTabPath = e.detail.name), this.navigate(e.detail.name)
          })
      }
      getContentElement() {
      ...
      handleEvent() {
        ...
        if (e && i) {
          if (this.containers[n.path]) this.syncHref(this.containers[n.path])
          else {
            const i = document.createElement(n.customElement)
            ;(i.style.display = 'block'),
              (i.style.overflow = 'scroll'),
              (i.style.width = 'inherit'),
              (i.style.height = 'inherit'),
              Object.keys(this.urlData).forEach(n => {
                i.setAttribute(n, e.urlData[n])
              }),
              (this.containers[n.path] = i)
          }
          this.getContentElement().replaceWith(this.containers[n.path]),
            this.getContentElement().scroll(0, this.scrollsTop[n.path] || 0),
            this.$tabbar.resetActiveColorForTabs(),
            (this.$tabbar.selected = n.path)
        }
      }
      syncHref(e = this) {
        const n = [
          ...
          i =
            ...
            this.matchedRouteLocation
        n.reduce((e, n) => {
          const i = `${e}/${n.matchedRouteLocation}`
          return (
            i !== location.href
              ? history.pushState({}, i, i)
              : history.replaceState({}, i, i),
            i
          )
        }, i)
      }
    }
    customElements.define('moko-tab-navigator', s)
  },
  function(e, n, i) {
    'use strict'
    i.r(n)
    ...
    class o extends HTMLElement {
      ...
      connectedCallback() {
        ...
        if (e && 'search' == e) {
          const e = getComputedStyle(this).color
          this.shadowRoot
            .querySelector('label')
            .style.setProperty(
              '--icon-svg',
              `url("data:image/svg+xml,${encodeURI(
                l.replace('currentColor', e)
              )}`
            )
        }
      }
    ...
    customElements.define('moko-text-input', o)
    n.default = o
  },
  function(e, n, i) {
    'use strict'
    i.r(n)
    var l =
      '<style>\n    svg {\n        width: inherit;\n        height: inherit;\n        stroke: currentColor;\n        stroke-width: 2;\n        stroke-width: var(--moko-icon-stroke-width);\n        stroke-linecap: round;\n        stroke-linejoin: round;\n        fill: none;\n    }\n</style>'
    const t = document.createElement('template')
    t.innerHTML =
      ...
      connectedCallback() {
        ...
        e &&
          (this.shadowRoot.innerHTML =
            o(t.content.querySelector(`#${e}`).innerHTML) + l)
      }
    }
    customElements.define('moko-icon', y)
    n.default = y
  },
  function(e, n, i) {
    'use strict'
      ...
      connectedCallback() {
        window.ShadyCSS && ShadyCSS.styleElement(this),
          ...
          this.backZone &&
            this.navigator &&
            this.navigator.pop &&
            (this.backZone.onclick = e => {
              this.navigator.pop()
            }),
          this.getAttribute('anim-back-title') &&
    ...
    customElements.define('moko-navigation-bar', t)
  },
  function(e, n, i) {
    'use strict'
    i.r(n)
    ...
    class t extends HTMLElement {
      constructor() {
        ...
        e.appendChild(l.content.cloneNode(!0)),
          (this.aside = e.querySelector('aside')),
          (this.backgroundCache = e.querySelector('.background-cache'))
      }
      connectedCallback() {
    ...
    customElements.define('moko-drawer', t)
  }
])
